...
public class Des {
	...
	public static void main(String[] args) throws Exception {
        String s = decryptECB3Des("10DBCB016838B168F765B62BA6014D06", "10DBCB016838B168F765B62BA6014D06");
        System.out.println(s);

        //Tripe-DES测试
		System.out.println("/*************Tripe-DES*************/");
		// 主密
		String masterKey = "B155E8427931E3AE2A5C7615B81D0ABB";
		// 数据
		String data = "25000E000E007300";
		System.out.println(DES_3(data, masterKey, 0));

		//密钥分散测试
		System.out.println("/*************GET DPK*************/");
		String dpk = getDPK("0302300100315415", "78274d1720202020",
				"B43C9882D9A01D3627086C02618BB371");
		System.out.println(dpk);

		//PBOC_DES_MAC生成测试
		System.out.println("/*************PBOC_DES_MAC*************/");
		System.out.println(PBOC_3DES_MAC("B155E8427931E3AE2A5C7615B81D0ABB",
				"0000000000000000",
				"00410D00000105B0007F0000000000006500308469E2859FCC6AB2AC3C4A4082B84630735D6F8124157E8412F3BCDB053C9EBCF4871B79937E2C0E78274D17",
				HEX));
	}
}
